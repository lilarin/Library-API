...
#             borrow_date=timezone.now().date(),  # Исправлено на использование datetime.date
#             expected_return_date=timezone.now().date() + timedelta(days=9),  # Исправлено на использование datetime.date
#             book=self.book,
#             user=self.user
#         )
#
